          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-4">
              <div className="bg-primary rounded p-4">
                <Link to="/">
                  <h1 className="text-white text-uppercase mb-3">LE' BEL MOR</h1>
                </Link>
                <p className="text-white mb-0">
                Discover the epitome of luxury and let us create unforgettable memories during your stay. Welcome to Le' Bel Mor, where your comfort is our utmost priority.
                </p>
              </div>
            </div>
